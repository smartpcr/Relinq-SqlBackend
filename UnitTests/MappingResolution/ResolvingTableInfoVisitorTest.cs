...
namespace Remotion.Linq.SqlBackend.UnitTests.MappingResolution
{
  ...
  public class ResolvingTableInfoVisitorTest
  {
    ...
    public void VisitUnresolvedJoinTableInfo_ResolvesJoin_AndRevisitsResult ()
    {
      ...
      _resolverMock
          .Expect (mock => mock.ResolveJoinTableInfo (unresolvedJoinTableInfo, _generator))
    ...
    public void VisitUnresolvedDummyRowTableInfo_ResolvesTableToStandardPattern ()
    {
      ...
      var result = ResolvingTableInfoVisitor.ResolveTableInfo (unresolvedDummyRowTableInfo, _resolverMock, _generator, _stageMock, _mappingResolutionContext);
